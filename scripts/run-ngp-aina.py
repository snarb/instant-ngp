...
if __name__ == "__main__":
	...
	if args.video_camera_path:
		...
		for i in tqdm(list(range(0, end_frame)), unit="frames", desc=f"Rendering video"):
			...
			if save_frames:
				...
				write_image(args.video_output % i, np.clip(frame * 2**args.exposure, 0.0, 1.0), quality=30)
			else:
